...
public class USMaps{
	...
	private static final String FILENAME = "blkgrp_pop_centroid_withname.txt";
	
	public static void main(final String[] args) {
		try {
			UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
		} catch (Exception e) {
			//do nothing. maybe die?
			System.exit(1);
		}
	...
	static void runProgram(Component parent){
		...
		InteractionPane.displayData(result.getElementA(), result.getElementB());
	}
