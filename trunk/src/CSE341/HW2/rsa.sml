...
(* 	Pre: y is not negative
	Post: takes x and multiply to power of y
*)
fun pow(x, 0) = 1
|	pow(x, y) = x * pow(x, y - 1);
...
(* 	Pre: Int list within range 1 to 127 inclusive
	Post: tkaes list of integers lst, a number k for max number of
	integers to pack, and a base b to use for packing. Produces 
	the list obtained by combining integers in the given base.
*)
fun pack(lst, k, b) = 
	let
		(* 	Pre: inital passed lst is correctly formatted,
