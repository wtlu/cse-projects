 ...
 * Wei-Ting Lu
 * CSE332 Project3
 * This class is a test for PQVersionFour to 
...
public class PQVersionFourTest {
	static PQVersionFour ver4;
	...
	public static void main(String[] args) {
		...
		ver4 = new PQVersionFour(data, 2, 2);
		_usGrid = ver4.processData();
		_totPopulation = _usGrid.population;
		
		
		//test unmodPopGrid and make sure all element in grid is 100
		int[][] unModResult = ver4.makePopGrid(_usGrid);
		...
		_xyPopGrid = ver4.makeGrid(_usGrid);
		_xyGrid = ver4.processPopulationToGrid(_usGrid, 2, 2);
		
		//Total Population should be 400
		System.out.println("The total population is (ver.4)" + _totPopulation);
		...
		int[][] actualResult = ver4.makeModifiedPopGrid(test);
	...
	public static Pair<Integer, Float> singleInteraction(int w, int s, int e, int n) {
		...
		int population = 0;
		ver4 = new PQVersionFour(_xyPopGrid);
		population = ver4.processQuery(n, s, e, w);
