 ...
 * Wei-Ting Lu
 * CSE332 Project3
 * This class is a test for PQVersionTwo to 
 * make sure that its methods produce the correct output
 * 
 */
public class PQVersionTwoTest {
	static PQVersionTwo ver2;
	...
	public static void main(String[] args) {
		...
		ver2 = new PQVersionTwo(data);
		_usGrid = ver2.processData();
		_totPopulation = _usGrid.population;
		_xyGrid = ver2.processPopulationToGrid(_usGrid, 2, 2);
		
		//Total Population should be 400
		System.out.println("The total population is (ver.2)" + _totPopulation);
	...
	public static Pair<Integer, Float> singleInteraction(int w, int s, int e, int n) {
		...
		int population = 0;
		population = ver2.processQuery(queryRect);
