 ...
 * Wei-Ting Lu
 * CSE332 Project3
 * This class is a test for PQVersionFive to 
...
public class PQVersionFiveTest {
	static PQVersionFive ver5;
	...
	public static void main(String[] args) {
		...
		ver5 = new PQVersionFive(data, 2, 2);
		_usGrid = ver5.processData();
		_totPopulation = _usGrid.population;
		
		
		//test unmodPopGrid and make sure all element in grid is 100
		int[][] unModResult = ver5.makePopGrid(_usGrid);
		...
		_xyPopGrid = ver5.makeGrid(_usGrid);
		_xyGrid = ver5.processPopulationToGrid(_usGrid, 2, 2);
		
		//Total Population should be 400
		System.out.println("The total population is (ver.5)" + _totPopulation);
		...
		int[][] actualResult = ver5.makeModifiedPopGrid(test);
	...
	public static Pair<Integer, Float> singleInteraction(int w, int s, int e, int n) {
		...
		int population = 0;
		ver5 = new PQVersionFive(_xyPopGrid);
		population = ver5.processQuery(n, s, e, w);
